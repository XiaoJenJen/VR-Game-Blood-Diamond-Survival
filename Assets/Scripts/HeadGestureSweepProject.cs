...
public class HeadGestureSweepProject : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        Debug.Log("sweeprate" + sweepRate + "prevangle" + previousCameraAngle);
    }

    private bool DetectFacingDown()
    {
        return (CameraAngleFromGround() < 45.0f);
    }
